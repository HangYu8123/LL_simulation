    ...
    while(flag):
        ...
        while done is False:
            ...
            if steps % 10 == 0:
                ...
                # print("***********************")
                # print(feedback)
                feedback = rescalors.dynamic_feedback(feedback, focus, bias, cons)
                # print(feedback)
                # print("***********************")
...
#Training("TAMER_STEADY", focus = 1)
Training("TAMER_STEADY\\B", bias = 1, st_b = -2/200000)
#Training("TAMER_STEADY\\F", focus = 1, st_f = -0.2/200000)
#Training("TAMER_STEADY\\C", cons = 1, st_c = -1/200000)
